                        ...
                        onPressed: () {
                          showDialog(
                            ...
                            builder: (context) => AlertDialog(
                              ...
                              content: const Text('Pour réinitialiser votre mot de passe ou récupérer votre compte, veuillez contacter directement votre administrateur ou le support technique via le web.'),
                              actions: [
                                TextButton(
